...
- [x] `volumes/v8-analise/18-espacos-lp.qmd` — Espaços $L^p$; desigualdades de Hölder e Minkowski; completude (Riesz–Fischer).
...
- [x] `volumes/v15-discreta/08-emparelhamentos-fluxos.qmd` — Emparelhamentos e fluxos em redes.
