...
**Fases:** o roadmap tem duas. Conclua **toda a Fase 1** (Volumes I–X) antes de
iniciar a **Fase 2** (extensões dos Volumes V e X + Volumes XI–XIII), salvo
...
- [~] `volumes/v1-fundamentos/01-logica.qmd` — Lógica e demonstrações: proposições, conectivos, quantificadores, métodos de prova.
...
- [ ] `volumes/v2-algebra/01-expressoes.qmd` — Expressões algébricas e manipulação.
...
- [ ] `volumes/v2-algebra/08-funcoes-polinomiais.qmd` — Funções polinomiais; teorema do resto e de D'Alembert.
- [ ] `volumes/v2-algebra/09-progressoes.qmd` — Progressões aritméticas e geométricas.
...
- [ ] `volumes/v3-geometria/01-euclidiana-axiomas.qmd` — Geometria euclidiana: axiomas, pontos, retas, ângulos.
...
- [ ] `volumes/v3-geometria/09-trigonometria-triangulo.qmd` — Trigonometria no triângulo retângulo; leis dos senos e cossenos.
...
- [ ] `volumes/v7-abstrata/07-aneis-polinomios.qmd` — Anéis de polinômios.
- [ ] `volumes/v7-abstrata/08-extensoes-corpos.qmd` — Extensões de corpos.
